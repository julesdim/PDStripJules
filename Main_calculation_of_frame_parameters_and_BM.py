...
swell_oural = Sw.Swell(0.6, 1.8, 4.17, 5, 7.56, 0)
swell_oural.plot_spreading(-90,270,10)
swell_oural.plot_JONSWAP(0.1,2.5,0.08)
# res=pdstrip.m_n_improved(2, swell_oural, 1.821)
# pdstrip.print_filewritting_max_BM(swell_oural,1.821,D,0.01)
...
# swell_oural = Sw.Swell(0.61, 1.8, 0, 5, 7.56, 230)
...
# swell_max0= Sw.Swell(0.61, 1.8, 4.17, 5, 7.56, 58)
# pdstrip.writing(swell_max0, 1.821)
# swell_max4=Sw.Swell(0.6, 1.8, 4.17, 5, 7.56,128)
# pdstrip.writing(swell_max4,1.821)

# swell_oural.plot_spreading(0,360,10)
